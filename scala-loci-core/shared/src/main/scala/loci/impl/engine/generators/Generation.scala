...
trait Generation {
  ...
  object trees {
    ...
    val AbstractionId = tq"$root.loci.transmission.AbstractionId"
    val AbstractionIdCreate = q"$root.loci.impl.AbstractionId.create"
    val AbstractionRef = tq"$root.loci.transmission.AbstractionRef"
    val Marshallable = q"$root.loci.transmission.Marshallable"
    val MarshallableArgument = q"$root.loci.transmission.MarshallableArgument"
